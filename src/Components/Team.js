        ...
        <div className="py-20 ">
            <div className="container mx-auto px-6 md:px-12 xl:px-32">
                <div className="mb-16 text-center">
                    ...
                    <p className="text-gray-600 lg:w-8/12 lg:mx-auto">Meet the experienced professionals who make up our team. Each member brings a unique set of skills and local knowledge to the table.</p>
                </div>
                <div className="grid gap-12 items-center md:grid-cols-3">
                    <div className="space-y-4 text-center">
                        ...
                        <div>
                            <h4 className="text-2xl">Aninakwa Kwaku Ntiri</h4>
